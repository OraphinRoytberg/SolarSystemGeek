...
<body>
    ...
    <nav>
        ...
        <ul>
        	<c:url value="/alienAgeInput" var="alienAgeHref" />
        	<c:url value="/alienWeightInput" var="alienWeightHref" />
        	<c:url value="/alienTravelInput" var="alienTravelHref" />
        	<c:url value="/geekPostResult" var="geekPostHref" />
        	<c:url value="/productList" var="productListHref" />
            <li><a href="${alienAgeHref}">Alien Age</a></li>
            <li><a href="${alienWeightHref}">Alien Weight</a></li>
            <li><a href="${alienTravelHref}">Drive Time</a></li>
            <li><a href="${geekPostHref}">Space Forum</a></li>  
            <li><a href="${productListHref}">Space Store</a></li>           
        </ul>
    </nav>